...
| ---: | ---: | ---: | ---: | ---: |
| `65536` | `31435` | `2509.00` | `259.70` | `0.00` |
| `131072` | `60257` | `5000.00` | `511.10` | `0.00` |
| `262144` | `116811` | `9963.00` | `997.75` | `0.00` |
| `524288` | `228560` | `19906.00` | `1895.80` | `0.00` |
| `1048576` | `453209` | `39825.00` | `3751.45` | `0.00` |

#### `DCF`：固定 `bin=64,bout=1`

| `N` | `keygen` (us) | `avg key upload transfer` (us) | `avg steady eval` (us) | `avg_transfer_p0/p1` |
| ---: | ---: | ---: | ---: | ---: |
| `65536` | `39116` | `2505.00` | `415.70` | `0.00` |
| `131072` | `69470` | `4997.50` | `830.20` | `0.00` |
| `262144` | `128149` | `9962.50` | `1627.60` | `0.00` |
| `524288` | `248617` | `19917.00` | `3092.55` | `0.00` |
| `1048576` | `485622` | `39824.00` | `6038.95` | `0.00` |
...
- 到 `N=1048576` 时：
  - `DPF avg steady eval = 3751.45 us`
  - `DCF avg steady eval = 6038.95 us`
